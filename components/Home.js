...
useEffect(() => {
    fetch('https://mymoviz2-backend-seven.vercel.app/movies')
  ...
  const movies = moviesData.map((data, i) => {
    ...
    return <Movie key={i} updateLikedMovies={updateLikedMovies} isLiked={isLiked} title={data.title} overview={data.overview} poster={poster_path} voteAverage={data.vote_average} voteCount={data.vote_count} />;
  });
